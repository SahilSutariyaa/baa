...
import styles from "../style/commen/policy.module.css";

const Terms = () => {
  return (
    <>
       <div className={styles.container}>
      <h1 className={styles.mainTitle}>Terms Policy</h1>

      <div className={styles.privacyItem}>
        <ul>
          <li className={styles.privacyItemList}>
            <h3 className={styles.privacyItemTitle}>Introduction :</h3>
            <div className={styles.privacyItemInner}>
              <p>
                This Privacy Policy describes how{" "}
                <strong>
                  This Privacy Policy describes how ALTERX PHARMACEUTICALS
                  PRIVATE LIMITED{" "}
                </strong>{" "}
                This Privacy Policy describes how and its affiliates
                (collectively " This Privacy Policy describes how and its
                affiliates (collectively "{" "}
                <strong>ALTERX PHARMACEUTICALS PRIVATE LIMITED </strong> This
                Privacy Policy describes how and its affiliates (collectively "
                , we, our, us") collect, use, share, protect or otherwise
                process your information/ personal data through our website{" "}
                <strong>www.alterx.in</strong> (hereinafter referred to as{" "}
                <strong>Platform</strong>). Please note that you may be able to
          ...
          <li className={styles.privacyItemList}>
            ...
            <div className={styles.privacyItemInner}>
              <p>
                ...
                to be person/association claiming to be{" "}
                <strong>ALTERX PHARMACEUTICALS PRIVATE LIMITED </strong>{" "}
                ...
                we request you to never provide such information. If you have
          ...
          <li className={styles.privacyItemList}>
            ...
            <div className={styles.privacyItemInner}>
              <p>
                ...
                conditions; conduct marketing research, analysis and surveys;
                and as otherwise described to you at the time of collection of
          ...
          <li className={styles.privacyItemList}>
            ...
            <div className={styles.privacyItemInner}>
              <p>
                ...
                required for us to provide you access to our services and
                products offered to you, to comply with our legal obligations,
                to enforce our user agreement, to facilitate our marketing and
                advertising activities, to prevent, detect, mitigate, and
                investigate fraudulent or illegal activities related to our
                services. We may disclose personal and sensitive personal data
                to government agencies or other authorised law enforcement
                ...
                personal data to law enforcement offices, third party rights
                owners, or others in the good faith belief that such disclosure
          ...
          <li className={styles.privacyItemList}>
            <h3 className={styles.subTitle}>Security Precautions :</h3>
            <div className={styles.privacyItemInner}>
              <p>
          ...
          <li className={styles.privacyItemList}>
            <h3 className={styles.subTitle}>Data Deletion and Retention :</h3>
            <div className={styles.privacyItemInner}>
              <p>
          ...
          <li className={styles.privacyItemList}>
            ...
            <div className={styles.privacyItemInner}>
              <p>
                ...
                in accordance with this Privacy Policy. You, while providing
                ...
                to contact you through SMS, instant messaging apps, call and/or
                e-mail for the purposes specified in this Privacy Policy. You
                ...
                our request. However, please note that your withdrawal of
                consent will not be retrospective and will be in accordance with
                the Terms of Use, this Privacy Policy, and applicable laws. In
